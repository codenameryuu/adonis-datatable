...
export default class Request {
  ...
  isColumnSearchable(index: number, columnSearch = true): boolean {
    if (columnSearch) {
      return (
        (this.input(`columns.${index}.searchable`, "true") === "true" || (this.input(`columns.${index}.searchable`, "true") as unknown as boolean) === true) &&
        this.columnKeyword(index) !== ""
      );
    }

    return this.input(`columns.${index}.searchable`, "true") === "true" || (this.input(`columns.${index}.searchable`, "true") as unknown as boolean) === true;
  }
